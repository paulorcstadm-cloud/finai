...
const FALLBACK_RESPONSES_PAULO: Record<string, string> = {
  consorcio: `**Consórcio Sicredi — Análise completa** 🏦\n\nSeu consórcio Sicredi está na parcela **34/100** com carta de **R$ 83.048,00** (corrigido pelo IPCA).\n\n**Vale a pena antecipar?**\n✅ Cada R$ 1.030,13 adiantado elimina uma parcela futura\n✅ Com R$ 5.000 você economiza ~4-5 parcelas\n✅ Equivale a uma taxa de retorno de ~12-14% a.a.\n\n**Minha recomendação:** Se você tem liquidez no Sicredi (R$ 8.420,00), considere antecipar pelo menos 2-3 parcelas para reduzir o prazo de 2031.`,
...
function getFallback(msg: string, isGabriel: boolean): string {
  ...
  if (/cons[oó]rc/i.test(lower)) return FALLBACK_RESPONSES_PAULO.consorcio
